...
Description: 16 input comparing/sorting testbench
Author: John Zhang
...
module_6 = 'input_16'
module_7 = 'input_16_bitonic_required'
testbench = 'test_%s' % module_6
...
srcs.append('../rtl/%s.v' % module_6)
srcs.append('../rtl/%s.v' % module_7)
